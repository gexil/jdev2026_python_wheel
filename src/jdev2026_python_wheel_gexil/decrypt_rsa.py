...
def run_decrypt_rsa():
    ...
    # data_path = files("jdev2026_python_wheel_gexil") / "data" / "primes.npz"
    # Python remplacera automatiquement __package__ par "jdev2026_python_wheel_gexil"
    data_path = files(__package__) / "data" / "primes.npz"
